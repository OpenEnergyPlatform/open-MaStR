...
TABLE_TRANSLATIONS = {
    ...
    "Bilanzierungsgebiete": "balancing_areas",
    "EinheitenAenderungNetzbetreiberzuordnungen": "changes_dso_assignment",
    "EinheitenBiomasse": "units_biomass",
    "EinheitenGasErzeuger": "units_gas_producers",
    "EinheitenGasSpeicher": "units_gas_storage",
    "EinheitenGasverbraucher": "units_gas_consumers",
    "EinheitenGenehmigung": "permits",
    "EinheitenGeothermieGrubengasDruckentspannung": "units_gsgk",
    "EinheitenKernkraft": "units_nuclear",
    "EinheitenSolar": "units_solar",
    "EinheitenStromSpeicher": "units_electricity_storage",
    "EinheitenStromVerbraucher": "units_electricity_consumers",
    "Einheitentypen": "unit_types",
    "EinheitenVerbrennung": "units_combustion",
    "EinheitenWasser": "units_hydro",
    "EinheitenWind": "units_wind",
    "Ertuechtigungen": "retrofits",
    "GeloeschteUndDeaktivierteEinheiten": "deleted_and_deactivated_units",
    "GeloeschteUndDeaktivierteMarktakteure": "deleted_and_deactivated_market_actors",
...
COLUMN_TRANSLATIONS = {
    ...
    "BiogasHoechstbemessungsleistung": "biogasMaximumRatedCapacity",
    "NetzbetreiberMastrNummerAlt": "oldGridOperatorMastrNumber",
    "NetzbetreiberMastrNummerNeu": "newGridOperatorMastrNumber",
    "ArtDerAenderung": "typeOfChange",
    "RegistrierungsdatumNetzbetreiberzuordnungsaenderung": "dsoAssignmentChangeRegistrationDate",
    "Netzbetreiberzuordnungsaenderungsdatum": "dsoAssignmentChangeDate",
    "NetzreserveZugeordnet": "gridReserveAssigned",
    "DatumNetzreserve": "dateGridReserve",
    "KapazitaetsreserveZugeordnet": "capacityReserveAssigned",
    "DatumKapazitaetsreserve": "dateCapacityReserve",
    "InbetriebnahmedatumAmAktuellenStandort": "commissioningDateAtCurrentLocation",
    "DatumDerAntragstellung": "dateOfApplication",
    "ArtDerSolaranlage": "typeOfSolarInstallation",
    ...
    "GebietNachDemFlaechenentwicklungsplanOstsee": "areaAccordingToSpatialDevelopmentPlanBalticSea",
    "Nachtkennzeichnung": "nightMarking",
    "TechnologieFlugwindenergieanlage": "technologyAirborneWindEnergySystem",
    "Flughoehe": "flightAltitude",
    "Flugradius": "flightRadius",
    "MarktakteurStatus": "marketActorStatus",
    "NetzanschlusspunkteMastrNummern": "networkConnectionPointsMastrNumbers",
    "MarktakteurAnrede": "marketActorSalutation",
    "MarktakteurTitel": "marketActorTitle",
    "Bilanzierungsgebiete": "balancingAreas",
}
