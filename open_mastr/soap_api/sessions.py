...
__author__ = "Ludee; christian-rli, gplssm"
...
class MaStRAPI(object):
    ...
    queries <https://www.marktstammdatenregister.de/MaStRHilfe/files/webdienst/Funktionen_MaStR_Webdienste_V1.2.26.html>`_
    ...
    def __init__(self, user=None, key=None):
        ...
        if user:
            ...
            self._user = get_mastr_user()
        if key:
            self._key = key
        else:
            self._key = get_mastr_token(self._user)
...
def _mastr_bindings(max_retries=3, pool_connections=2000, pool_maxsize=2000,
                   timeout=600, wsdl='https://www.marktstammdatenregister.de/MaStRAPI/wsdl/mastr.wsdl',
                   service_name='Marktstammdatenregister', service_port='Anlage'):
    """
