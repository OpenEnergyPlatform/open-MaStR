...
from open_mastr.soap_api.mastr_solar_download import *
from open_mastr.soap_api.utils import fname_power_unit_solar, fname_solar_unit, fname_solar_eeg, fname_solar
