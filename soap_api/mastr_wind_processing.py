...
""" import variables """
from soap_api.utils import fname_power_unit, fname_wind, fname_wind_unit, fname_wind_eeg, fname_wind_eeg_unit, fname_wind_permit, remove_csv, read_power_units, split_to_sublists
