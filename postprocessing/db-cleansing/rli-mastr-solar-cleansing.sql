...
-- Create a copy
DROP TABLE IF EXISTS model_draft.bnetza_mastr_rli_v2_4_1_solar_clean CASCADE;
CREATE TABLE         model_draft.bnetza_mastr_rli_v2_4_1_solar_clean AS
    SELECT  * 
    FROM    model_draft."bnetza_mastr_rli_v2_4_1_unit-solar"
    ORDER BY id;
...
UPDATE  model_draft.bnetza_mastr_rli_v2_4_1_solar_clean
    SET "Laengengrad" =  REGEXP_REPLACE("Laengengrad",'[[:alpha:]]','','g');

ALTER TABLE model_draft.bnetza_mastr_rli_v2_4_1_solar_clean ALTER COLUMN "Laengengrad" TYPE double precision USING "Laengengrad"::double precision;
...
FROM model_draft.bnetza_mastr_rli_v2_4_1_solar_clean
LIMIT 10;
...
-- Check geom
UPDATE  model_draft.bnetza_mastr_rli_v2_4_1_solar_clean AS t1
...
-- Punkte innerhalb vg250
    ...
    FROM    (
        ...
        FROM    boundaries.bkg_vg250_1_sta_union_mview AS vg,
                model_draft.bnetza_mastr_rli_v2_4_1_solar_clean AS m
