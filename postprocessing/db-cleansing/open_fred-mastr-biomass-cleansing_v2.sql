...
-- Create a copy
DROP TABLE IF EXISTS model_draft.bnetza_mastr_rli_v2_5_5_biomass_clean CASCADE;
CREATE TABLE         model_draft.bnetza_mastr_rli_v2_5_5_biomass_clean AS
    SELECT  * 
    FROM    model_draft.bnetza_mastr_rli_v2_5_5_biomass
    ORDER BY id;
...
FROM model_draft.bnetza_mastr_rli_v2_5_5_biomass_clean
LIMIT 10;
...
-- Check geom
UPDATE  model_draft.bnetza_mastr_rli_v2_5_5_biomass_clean AS t1
...
-- Punkte innerhalb vg250
    ...
    FROM    (
        ...
        FROM    boundaries.bkg_vg250_1_sta_union_mview AS vg,
                model_draft.bnetza_mastr_rli_v2_5_5_biomass_clean AS m
...
FROM model_draft.bnetza_mastr_rli_v2_5_5_biomass_clean_50hertz
