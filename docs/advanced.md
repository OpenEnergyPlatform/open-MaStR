...
|---------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|
| `MASTR_PROJECT_HOME_DIR`    | Path to the project home directory where config files and logs are stored. Defaults to `$HOME/.open-MaStR/`.                                                                                                                                     | `/home/mastr-rabbit/.open-MaStR/`                                                                                      |
