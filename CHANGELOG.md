...
### Changed
- Fix `Mastr.to_csv` failing with "Invalid isoformat string" on date values whose year is not zero-padded to four digits. Those dates are now imported as they are and exported as empty values with a warning.
